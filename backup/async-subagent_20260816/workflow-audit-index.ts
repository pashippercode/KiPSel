...
const PHASE_TOOLS: Record<Phase, ReadonlySet<string>> = {
	plan: new Set(["read", "bash", "grep", "find", "ls", "subagent", "audit_set_phase", "subagent_set_model", "get_goal", "update_goal", "todo_write", "llm_query", "deliver", "optimize_prompt"]),
	active: new Set(["read", "bash", "edit", "write", "grep", "find", "ls", "subagent", "audit_set_phase", "subagent_set_model", "get_goal", "update_goal", "todo_write", "llm_query", "deliver", "optimize_prompt"]),
	review: new Set(["read", "bash", "grep", "find", "ls", "subagent", "audit_set_phase", "subagent_set_model", "get_goal", "update_goal", "todo_write", "llm_query", "deliver", "optimize_prompt"]),
	verify: new Set(["read", "bash", "grep", "find", "ls", "audit_set_phase", "subagent_set_model", "get_goal", "update_goal", "todo_write", "llm_query", "deliver", "optimize_prompt"]),
	capture: new Set(["read", "bash", "edit", "write", "grep", "find", "ls", "audit_set_phase", "subagent_set_model", "get_goal", "update_goal", "todo_write", "llm_query", "deliver", "optimize_prompt"]),
};
